...
CREATE TABLE IF NOT EXISTS geo_dummy_features
(
    survey_id TEXT,
    link TEXT,
    di_MISSING REAL,
    ...
    mt_brodno REAL,
    mt_centrum REAL,
    mt_centrum_nauki_kopernik REAL,
    mt_dw_gdanski REAL,
    mt_imielin REAL,
    mt_kabaty REAL,
    mt_kondratowicza REAL,
    mt_ksiecia_janusza REAL,
    mt_marymont REAL,
    mt_mlociny REAL,
    mt_mlynow REAL,
    mt_natolin REAL,
    mt_nowy_swiat_uniwersytet REAL,
    mt_plac_wilsona REAL,
    mt_plocka REAL,
    mt_pole_mokotowskie REAL,
    mt_politechnika REAL,
    mt_raclawicka REAL,
    mt_ratusz REAL,
    mt_rondo_daszynskiego REAL,
    mt_rondo_onz REAL,
    mt_slodowiec REAL,
    mt_sluzew REAL,
    mt_stadion_narodowy REAL,
    mt_stare_bielany REAL,
    mt_stoklosy REAL,
    mt_swietokrzyska REAL,
    mt_szwedzka REAL,
    mt_targowek_mieszkaniowy REAL,
    mt_ulrychow REAL,
    mt_ursynow REAL,
    mt_wawrzyszew REAL,
    mt_wierzbno REAL,
